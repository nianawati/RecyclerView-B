package com.mudhiya.recyclerviewb;
    ...
    private void filter(String text) {
        ...
        for (MahasiswaModel item : mahasiswaModelList) {
            if (item.getNama().toLowerCase().contains(text.toLowerCase())) {
                Toast.makeText(MainActivity.this, "test", Toast.LENGTH_SHORT).show(); // Ini hanya untuk debugging
...
//                loadRecyclerView(); // Memuat ulang data setelah kembali dari AddMahasiswaActivity
            }
        });
    }
